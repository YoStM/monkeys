 ...
 */
final class Version20210121111247 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT NOT NULL, project_id INT NOT NULL, user_id_id INT NOT NULL, contributor_id_id INT NOT NULL, description TEXT NOT NULL, deadline DATE NOT NULL, price INT NOT NULL, create_date DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE project (id INT NOT NULL, category_id_id INT NOT NULL, user_id_id INT NOT NULL, owner_id_id INT NOT NULL, title VARCHAR(155) NOT NULL, description TEXT NOT NULL, create_date DATE NOT NULL, modify_date DATE DEFAULT NULL, active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE offer ADD CONSTRAINT FK_29D6873E9D86650F FOREIGN KEY (user_id_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
